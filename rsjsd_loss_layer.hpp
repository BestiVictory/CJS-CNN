#ifndef CAFFE_RSJSD_LOSS_LAYER_HPP_
#define CAFFE_RSJSD_LOSS_LAYER_HPP_
...
class RSJSDLossLayer : public LossLayer<Dtype> {
 public:
  explicit RSJSDLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param),diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "RSJSDLoss"; }
