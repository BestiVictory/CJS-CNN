#ifndef CAFFE_JSD_LOSS_LAYER_HPP_
#define CAFFE_JSD_LOSS_LAYER_HPP_
...
class JSDLossLayer : public LossLayer<Dtype> {
 public:
  explicit JSDLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param),diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "JSDLoss"; }
